<%-- 
    Document   : moduloMonitor
    Created on : 19-nov-2017, 1:15:00
    Author     : DavidLenovo
--%>
...
<%
	...
	if (sesionOk.getAttribute("usuario") == null){
		...
		usuario=""+sesionOk.getAttribute("usuario");
                tipo=""+sesionOk.getAttribute("tipo");
	}
%>
<!DOCTYPE html>
<html>
    ...
    <body class="panel panel-body">
        <div class="container">
            ...
            <div class="cabecera page-header ">
                <header class="titulo">
                    <h1 style="font-size: 500%;" class="text-center">Monitores</h1>
                </header>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                    ...
                    <div class="thumbnail text-center" style="background: transparent">
                        <h4>Monitor</h4>
                        <img src="../images/monitor.png" style="height: 5vw">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                    ...
                    <ul class="nav nav-tabs">
                      <li class="active"><a data-toggle="tab" href="#miArea">Mi Area</a></li>
                    ...
                    <div class="tab-content">
                      <div id="miArea" class="tab-pane fade in active text-center">
                          <h3 class="text-primary">
                              <img src="../images/personal.png" style="height: 5vw;">
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title text-center">Nueva Publicacion</h4>
                          </div>
